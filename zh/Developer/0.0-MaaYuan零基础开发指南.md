...
<!-- 2. 打开 [MaaYuan主仓库](https://github.com/syoius/MaaYuan)，点击 `Fork`，继续点击 `Create fork` -->
...
<details>
  <summary><b>如已克隆但发现资源缺失?</b></summary>
...
<details>
   <summary><b>想要在指定文件夹下载？</b></summary>
...
<details>
   <summary><b>我没有下git/git下载不下来/git clone总是失败，怎么办？</b></summary>
...
>
<!-- >> 推荐自动生成提交信息工具：[OpenCommit](https://github.com/di-sukharev/opencommit) -->
>
> 假如你不熟悉 git 的使用，你可能需要**创建并切换到一个新的分支**，而不是直接提交在 main 上。这样你的提交就能在新的分支上生长，不会受到 main 更新的打扰。
>