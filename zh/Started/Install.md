...
- 【最省事】[Mirror酱]下载，详细介绍请查阅[【常见问题-Mirror酱是什么】](XXX)。
- 【第一手】[GitHub]下载，需要科学上网，如果喜欢`MaaYuan`，请在项目右上角点亮`Star`支持。
...
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| 依赖库主要安装步骤 | 打开`MaaYuan`文件夹右键点击`DependencySetup_依赖库安装_win.bat`选择“以管理员身份运行”                                                                             | 打开`MaaYuan`文件夹点击“新建位于文件夹位置的终端窗口”或点击`启动台-其他-终端`输入指令 `sh DependencySetup_依赖库安装_mac.sh` |
| 若依赖库安装失败   | 下载**VCRedist**：点击 [**vc_redist.x64**] 下载并安装完成；下载**NET10**：点击[**.NET 官方下载页面**]选择 .NET **桌面运行时**-Windows **x64**进行下载并安装完成。 | 无需下载**VCRedist**；下载**NET10**：点击[**.NET 官方下载页面**]选择 .NET**运行时**-macOS **Arm64**进行下载并安装完成。      |
